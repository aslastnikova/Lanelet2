...
class OsmWriter : public Writer {
 public:
  ...
  void write(const std::string& filename, const LaneletMap& laneletMap, ErrorMessages& errors,
             const io::Configuration& params = io::Configuration(), bool updateVersions = false) const override;
  
  // void write(const std::string& filename, const LaneletMap& laneletMap, ErrorMessages& errors,
  //            const io::Configuration& params = io::Configuration(), bool updateVersions = false) const;
  ...
  std::unique_ptr<osm::File> toOsmFile(const LaneletMap& laneletMap, ErrorMessages& errors,
                                       ...
                                       bool updateVersions = false) const;
